...
static void MD5_Transform(UINT4 *buf, const UINT4 *in) {
...
void MD5Update(MD5_CTX *mdContext, unsigned char *inBuf, int32_t inLen) {
    ...
    auto mdi = static_cast<int32_t>((mdContext->i[0] >> 3) & 0x3F);
